...
describe("groupById", function() {
  ...
  describe("copy sorted", function () {
    ...
    it(" copy sorted", function () {
        assert.notStrictEqual(copySorted(["HTML", "JavaScript", "CSS"]), ["HTML", "JavaScript", "CSS"]);
    });
  });
...
//         assert.StrictEqual(getAverageAge({ name: "John", age: 25 }), 25);
//     });
//   });
